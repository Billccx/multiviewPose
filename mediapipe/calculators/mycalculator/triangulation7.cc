...
namespace mediapipe{
    ...
    class TriangulationCalculator7 : public CalculatorBase {
        public:
        int gcnt;
        int udp_socket; 
        const int port;
        ...
        TriangulationCalculator7():gcnt(0),port(31201){
        ...
        absl::Status Process(CalculatorContext* cc) override{
            ...
            /*
            std::ofstream outfile("/home/cuichenxi/mediapipe/mediapipe/examples/desktop/mypose8/data/"+
    ...
    REGISTER_CALCULATOR(TriangulationCalculator7);
