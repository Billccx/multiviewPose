...
namespace mediapipe{
    ...
    class TriangulationCalculator6 : public CalculatorBase {
        public:
        int gcnt;
        int udp_socket; 
        const int port;
        ...
        TriangulationCalculator6():gcnt(0),port(31201){
        ...
        absl::Status Process(CalculatorContext* cc) override{
            ...
            for(int i=0;i<33;i++){
                std::vector<double> x={0.2,0.2,0.2};
            ...
            /*
            std::ofstream outfile("/home/cuichenxi/mediapipe/mediapipe/examples/desktop/mypose7/data2/"+
    ...
    REGISTER_CALCULATOR(TriangulationCalculator6);
